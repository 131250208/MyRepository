...
public class AIeasy extends AIcomputer {
		    	    					...
		    	    					for(a=0;a<5;a++){
		    	    	    	    		for(b=0;b<5;b++){
		    	    	    	    			if(p==0){
		    	    	    	    				if(a>=1){
			    	    	    	    				if(hb[a][b]==0&&sb[b][a]!=0&&hb[a+1][b]!=0&&sb[b+1][a]!=0){
			    	    	    	    					if(hb[a-1][b]==0 && sb[b][a-1]!=0 && sb[b+1][a-1]!=0){
			    	    	    	    						for(e=1;e<26;e++){
			    	    	    	    				    		if(num[e]==1||num[e]==2){
			    	    	    	    				    			h++;
			    	    	    	    				    		}
		    	    	    	    				...
		    	    	    	    				if(b>=1){
			    	    	    	    				if(hb[a][b]!=0&&sb[b][a]==0&&hb[a+1][b]!=0&&sb[b+1][a]!=0){
			    	    	    	    					if(sb[b-1][a]==0 && hb[a][b-1]!=0 && hb[a+1][b-1]!=0){
			    	    	    	    						for(e=1;e<26;e++){
			    	    	    	    				    		if(num[e]==1||num[e]==2){
			    	    	    	    				    			h++;
			    	    	    	    				    		}
		    	    	    	    				...
		    	    	    	    				if(a<4){
			    	    	    	    				if(hb[a][b]!=0&&sb[b][a]!=0&&hb[a+1][b]==0&&sb[b+1][a]!=0){
			    	    	    	    					if(hb[a+2][b]==0 && sb[b][a+1]!=0 && sb[b+1][a+1]!=0){
			    	    	    	    						for(e=1;e<26;e++){
			    	    	    	    				    		if(num[e]==1||num[e]==2){
			    	    	    	    				    			h++;
			    	    	    	    				    		}
		    	    	    	    				...
		    	    	    	    				if(b<4){
			    	    	    	    				if(hb[a][b]!=0&&sb[b][a]!=0&&hb[a+1][b]!=0&&sb[b+1][a]==0){
			    	    	    	    					if(sb[b+2][a]==0 && hb[a][b+1]!=0 && hb[a+1][b+1]!=0){
			    	    	    	    						for(e=1;e<26;e++){
			    	    	    	    				    		if(num[e]==1||num[e]==2){
			    	    	    	    				    			h++;
			    	    	    	    				    		}
